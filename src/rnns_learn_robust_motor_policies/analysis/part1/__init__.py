...
ANALYSIS_SETS = {
    "1-1": (setup_plant_perts, eval_func_plant_perts, ANALYSES_PLANT_PERTS), 
    "1-2": (setup_feedback_perts, eval_func_feedback_perts, ANALYSES_FEEDBACK_PERTS),
    "1-3": (setup_freq_response, eval_func_freq_response, ANALYSES_FREQ_RESPONSE),
}