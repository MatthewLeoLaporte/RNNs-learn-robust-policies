...
```{python}
# TODO 
# TODO Maybe do this for all the notebooks.
# TODO
...
```{python}
models_base, model_info, replicate_info, n_replicates_included = query_and_load_model(
    db_session,
    setup_task_model_pair,
    params_query=dict(origin=TRAIN_NB_ID) | params_load,
    noise_stds=dict(
