...
def main(
    ...
    map = partial(jtree.map_tqdm, labels=jtree.labels(analyses))
    # map = jt.map
    
    all_results, all_figs = jtree.unzip(map(
        analyse_and_save, 
        analyses, 
...
if __name__ == '__main__':
    ...
    parser.add_argument("config_path", type=str, help="Path to the config file, or `expt_id` for the default config.")
